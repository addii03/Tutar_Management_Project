<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin_dashboard.Master" AutoEventWireup="true" CodeBehind="View_Contact.aspx.cs" Inherits="Tutar_Management_Project.admin.View_Contact" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <h1 class="p-5 mb-4 bg-dark text-white text-center">VIEW CONTACT DETAILS</h1>
        </div>
    </div>
