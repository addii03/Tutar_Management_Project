<%@ Page Title="" Language="C#" MasterPageFile="~/tutor/Tutor_Dashboard.Master" AutoEventWireup="true" CodeBehind="View_Student.aspx.cs" Inherits="Tutar_Management_Project.tutor.View_Student" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <h1 class="p-5 mb-4 bg-dark text-white text-center">STUDENTS DATA</h1>
        </div>
    </div>
    <div class="row">
        <div class="col-md-4">
            <div class="input-group">
                <asp:TextBox ID="SearchTextBox" class="form-control" placeholder="Search Student" runat="server"></asp:TextBox>
