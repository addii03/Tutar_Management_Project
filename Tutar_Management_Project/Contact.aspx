<%@ Page Title="" Language="C#" MasterPageFile="~/TMS_Site.Master" AutoEventWireup="true" CodeBehind="Contact.aspx.cs" Inherits="Tutar_Management_Project.Contact" %>
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
              <div class="row">
                ...
                <div class="col-md-6 form-group mt-3 mt-md-0">
                  <%--<input type="email" class="form-control" name="email" id="email" placeholder="Your Email" required>--%>
                    ...
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" ControlToValidate="EmailTextBox" ForeColor="Red" SetFocusOnError="true" Display="Dynamic" runat="server" ErrorMessage="Invalid Email ID" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"></asp:RegularExpressionValidator>
                </div>
              </div>
              ...
              <div class="text-center">
                ...
                <asp:Button ID="SubmitButton" class="form-control"  runat="server" Text="Submit"  CssClass="btn btn-info" OnClick="SubmitButton_Click"/>
                 </div>
