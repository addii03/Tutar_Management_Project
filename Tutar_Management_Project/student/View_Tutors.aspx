<%@ Page Title="" Language="C#" MasterPageFile="~/student/Student_Dashboard.Master" AutoEventWireup="true" CodeBehind="View_Tutors.aspx.cs" Inherits="Tutar_Management_Project.student.View_Tutors" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <h1 class="p-5 mb-4 bg-dark text-white text-center">TUTORS DATA</h1>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <div class="input-group">
                <asp:TextBox ID="SearchTextBox" class="form-control" placeholder="Search Tutor" runat="server"></asp:TextBox>

                <button id="SearchBtn" runat="server" class="btn btn-secondary" onserverclick="SearchBtn_ServerClick" type="button">
